...
#define defaults_h
  ...
  #define DEFAULT_X_ACCELERATION (16.0*60*60) // 16 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (16.0*60*60) // 16 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (16.0*60*60) // 16 mm/sec^2
